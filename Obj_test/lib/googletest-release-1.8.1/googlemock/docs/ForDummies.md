...
Using the `Turtle` interface as example, here are the simple steps you need to follow:
  ...
  1. Now comes the fun part: you take the function signature, cut-and-paste the _function m_name as the _first_ argument to the macro, and leave what's left as the _second_ argument (in case you're curious, this is the _type of the function_).

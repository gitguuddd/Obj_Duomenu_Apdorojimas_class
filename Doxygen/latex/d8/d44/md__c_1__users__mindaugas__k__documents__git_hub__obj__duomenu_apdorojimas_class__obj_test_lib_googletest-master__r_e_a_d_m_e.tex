...
\begin{DoxyItemize}
\item 1.\+8.\+x Release -\/ \href{https://github.com/google/googletest/releases/tag/release-1.8.1}{\texttt{ the 1.\+8.\+x}} is the last release that works with pre-\/\+C++11 compilers. The 1.\+8.\+x will not accept any requests for any new features and any bugfix requests will only be accepted if proven \char`\"{}critical\char`\"{}
